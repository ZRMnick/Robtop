...
prefix = '!'
admins = [admin user id 1, admin user id 2, ect, ect]
commandchannel = memeber farm channel id
logs = Logs channel id
addbot = Add bot channel id
blacklist_log = blacklis channel id
verifybot_token = 'verification bot tokens'
...
def join(guildid, amount):
    ...
    url = f'https://discord.com/api/v9/guilds/{guildid}/members/{useridd}'

    botToken = "verification bot tokens"
